...
CNL = ["restart","addOP","delOP","ban","bomb","offline","kick","dumb","help","listOP"]              #设置CommandNameList,指令名称列表。
...
xc=XChat.XChat("机器人的token","xq102210","TestBot","TestBotPassword")                                        #提供4个参数分别是机器人的token、聊天室名称、昵称、密码。
